  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-950 to-black">
        <div className="text-ink-gold text-xl font-cinzel">Loading...</div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-950 to-black p-4">
        <div className="parchment scroll-border rounded-lg p-8 shadow-2xl w-full max-w-md">
          <h1 className="text-4xl font-cinzel font-bold text-center mb-4 text-ink-gold text-shadow-medieval">
            SalaSpell Helper
          </h1>
          <div className="w-24 h-1 bg-dnd-gold mx-auto mb-6"></div>
          <p className="text-center font-medieval text-ink-gold-soft mb-6 text-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="text-ink-gold text-sm text-center font-medieval font-semibold">{error}</div>
            )}
            <button
              type="submit"
              className="w-full bg-red-900 hover:bg-red-800 text-ink-gold font-cinzel font-bold py-3 rounded-lg transition-colors duration-200 border-2 border-amber-800 shadow-lg hover:shadow-xl"
            >
              Enter the Tome
            </button>
          </form>
